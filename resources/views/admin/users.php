                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <form action="" id="form" method="post">
                                ...
                                if ($total > $sotin1trang){echo '<center>' . pagination(base_url("index.php?module=admin&action=users&username=$username&name=$name&email=$email&phone=$phone&status=$status&role=$role&money=$money&ck=$ck&ip=$ip&"), $from, $total, $sotin1trang) . '</center>';}?>
                                    </div>
                                </div>
                        </div>
                        </form>
