                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-12 mb-3">
                                    <form action="" name="formSearch" method="GET">
                                        ...
                                        <div class="row">
                                            ...
                                            <select class="form-control select2bs4 col-sm-2 mb-2" name="id_connect_api">
                            ...
                            <div class="row">
                                ...
                                if ($total > $sotin1trang){echo '<center>' . pagination(base_url("index.php?module=admin&action=product-order&transid=$transid&transidAPI=$transidAPI&buyer=$buyer&product=$product&id_connect_api=$id_connect_api&"), $from, $total, $sotin1trang) . '</center>';}?>
                                </div>
                            </div>
                        </div>
                    </div>
