                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-12 mb-3">
                                    <form action="" name="formSearch" method="GET">
                                        ...
                                        <div class="row">
                                            <select class="form-control select2bs4 col-sm-2 mb-2" name="user_id">
                                                <option value="">Username</option>
                                                <?php foreach($CMSNT->get_list("SELECT * FROM `users` ") as $row):?>
                                                <option <?=$user_id == $row['id'] ? 'selected' : '';?>
                                                    value="<?=$row['id'];?>">
                                                    <?=$row['username'];?> (<?=$row['id'];?>)
                                                </option>
                                                <?php endforeach?>
                            ...
                            <div class="row">
                                ...
                                if ($total > $sotin1trang){echo '<center>' . pagination(base_url("index.php?module=admin&action=invoices&user_id=$user_id&trans_id=$trans_id&status=$status&method=$method&"), $from, $total, $sotin1trang) . '</center>';}?>
                                </div>
                            </div>
                        </div>
                    </div>
