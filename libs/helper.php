...
function sendMessTelegram($my_text, $token = '', $chat_id = ''){
    ...
    if($token != '' && $chat_id != ''){
        return curl_get("https://api.telegram.org/bot".$token."/sendMessage?chat_id=".$chat_id."&text=".$my_text);
    }
    return true;
}
...
$d986876a52 = __DIR__ . '/../models/is_license.php';
$d29g8595268 = sha1_file($d986876a52);
if ($d29g8595268 != '086225514cf64f2e4cd72fcbc78b349fdc854887') { 
